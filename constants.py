...
MAX_SCAN_RANGE = 14.3
MAX_PIXEL_SPREAD = 5
SCRAMBLER_EQUIPPED = os.environ.get('SCRAMBLER_EQUIPPED')
WEBIFIER_EQUIPPED = os.environ.get('WEBIFIER_EQUIPPED')
DRONES_EQUIPPED = os.environ.get('DRONES_EQUIPPED')
REPAIRER_EQUIPPED = os.environ.get('REPAIRER_EQUIPPED')
REPAIRER_CYCLE_TIME = 4.5
SHORT_SCAN_THRESHOLD = 15
PAUSE_AFTER_DESTINATION_BROADCAST = 6
...
MINMATAR_SYSTEMS = ['Roushzar'] #['Kourmonen', 'Huola', 'Sosala', 'Anka']
AMARR_SYSTEMS = ['Kamela', 'Lamaa']
